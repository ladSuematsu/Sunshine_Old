...
import ladsoft.asynctest.entity.City;
import ladsoft.asynctest.entity.Forecast;
import ladsoft.asynctest.entity.ForecastResult;
import ladsoft.asynctest.entity.Temperature;
import ladsoft.asynctest.entity.Weather;
import ladsoft.asynctest.listener.AsyncOperatorCallback;
import ladsoft.asynctest.manager.AsyncTaskManager;
...
public class CurrentForecastFragment extends SwipeRefreshFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mContentView = getLayoutInflater(savedInstanceState).inflate(R.layout.fragment_main, null);
